...
const buttonConfig = {
  primary: {
    ...
    outline:
      "border-2 border-primary-500 text-primary-500  bg-opacity-0 hover:bg-primary-25",
  },
  secondary: {
    fill: "bg-gray-500 hover:bg-gray-600 active:bg-gray-700 text-white hover:text-gray-100",
    outline:
      "border-2 border-gray-500 text-gray-500  bg-opacity-0 hover:bg-secondary-25",
  },
  error: {
    fill: "bg-error-500 hover:bg-error-600 active:bg-error-700 text-white hover:text-gray-100",
    outline:
      "border-2 border-error-500 text-error-500  bg-opacity-0 hover:bg-error-25",
  },
  warning: {
    fill: "bg-warning-500 hover:bg-warning-600 active:bg-warning-700 text-white hover:text-gray-100",
    outline:
      "border-2 border-warning-500 text-warning-500  bg-opacity-0 hover:bg-warning-25",
  },

  sm: "px-6 py-4 text-lg rounded-md shadow-md active:shadow-sm",
  md: "px-10 py-5 text-xl rounded-md shadow-lg active:shadow-md",
  lg: "px-12 py-6 text-xl rounded-md   shadow-lg active:shadow-md",
};
