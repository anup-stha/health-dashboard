    ...
    <div className="flex items-center justify-between h-full space-x-4">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex flex-col space-y-1">
          <span className="text-2xl text-primary_gray-800 font-medium line-clamp-1 ">{title}</span>
          <span className="text-lg text-primary_gray-500 font-medium w-3/4 line-clamp-2">{subtitle}</span>
        </div>
      </div>
