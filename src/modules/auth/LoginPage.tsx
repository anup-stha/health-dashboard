  ...
  return (
    ...
    >
      <div className="flex w-full bg-white max-w-6xl flex-grow rounded-3xl shadow-E400 3xl:max-w-[60%] sm:max-w-none h-full">
        ...
        <div className="flex flex-col justify-between gap-y-20 w-3/5 px-20 py-32 sm:px-4 sm:bg-gray-200 rounded-tl-none rounded-bl-none  sm:rounded-none sm:justify-center sm:w-full sm:h-full sm:py-6 lg:px-12  bg-out-transition  ">
          <div className="gap-y-28 flex flex-col sm:px-8 sm:py-12 sm:rounded-2xl sm:shadow-E300 sm:bg-white">
            <div className="flex flex-col text-left fadeInLogin">
              <h1 className="text-5xl font-medium text-gray-800 sm:text-4xl lg:text-3xl">
                Hello! Welcome Back
              </h1>
            ...
            <LoginForm />
            <div className="-mt-5  flex flex-col items-start fadeInLogin">
