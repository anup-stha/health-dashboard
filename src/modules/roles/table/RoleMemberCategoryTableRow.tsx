...
export const RoleMemberCategoryTableRow = ({ data, key }: any) => {
  return (
    <tr key={key} data-testid="detail_cat_row">
      <td
        className="px-6 py-4 whitespace-nowrap text-lg font-medium text-primary_gray-850 w-auto"
        data-testid={`detail_cat_row_name_${data.id}`}
      >
        {data.name}
      </td>
      <td
        className="px-6 py-4 whitespace-nowrap text-lg font-medium text-primary_gray-700 w-auto"
