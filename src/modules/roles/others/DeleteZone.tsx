...
export const DeleteZone = () => {
  return (
    <div className="bg-white shadow-sm w-2/3 py-8 px-8 rounded-sm flex justify-between items-center lg:w-full sm:px-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Delete this role</h1>
...
export const TestDeleteZone = () => {
  return (
    <div className="bg-white shadow-sm w-2/3 py-8 px-8 rounded-sm flex justify-between items-center lg:w-full sm:px-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Delete this test</h1>
        <p className="text-lg font-semibold text-gray-500">
...
export const SubscriptionDeleteZone = () => {
  return (
    <div className="bg-white shadow-sm w-2/3 py-8 px-8 rounded-sm flex justify-between items-center lg:w-full sm:px-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Delete this subscription</h1>
        <p className="text-lg font-semibold text-gray-500">
